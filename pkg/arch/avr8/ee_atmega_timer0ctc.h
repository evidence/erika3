...
/** \file	ee_atmega_timer0ctc.h
 *  \brief	Timer 0 in CTC Mode.
 *
 *  Timer 0 is available on ATmega168, ATmega328 and on ATmega2560.
 *
...
#ifndef	OSEE_ATMEGA_TIMER_0_CTC_H
#define	OSEE_ATMEGA_TIMER_0_CTC_H
...
/** \brief	Timer 0 Start.
 *  \param	microsecondsInterval	Timer 0 Period (us).
 *
 *  Initializes and Start Timer 0 in CTC Mode.
 *
 ...
 *  		- x <   20480:	64      us
 *
 *  \note	Enables Output Compare A Match Interrupt for Timer 0:
...
#endif	/* OSEE_ATMEGA_TIMER_0_CTC_H */
