...
/** \file	ee_atmega_mcu.h
 *  \brief	ATMEGA MCU.
 *
 *  This files contains the support for Atmel ATMEGA MCU in Erika Enterprise.
 *
...
#ifndef	OSEE_INCLUDE_ATMEGA_MCU_H
#define	OSEE_INCLUDE_ATMEGA_MCU_H
...
EE_INLINE__ void EE_mcu_init(void)
{
