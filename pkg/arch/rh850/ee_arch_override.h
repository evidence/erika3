...
/*==============================================================================
 ...
 =============================================================================*/
/*
 * RH850 support both 4 and 8 bytes alignment, is left to compiler options.
 * If we force 8 bytes alignment we are always fine.
 */
...
/* Override RQ Mask Empty Value to better implement osEE_hal_get_msb */
#define OSEE_RQ_MASK_EMPTY    (32U)
