...
/** \file   r_peid3_cfg.c
 *  \brief  project configuration for PEID3  (core 3)
 *
 ...
 *******************************************************************************/
const g4mh_isr_t g_peid3_FePrjCfg[] =
{
