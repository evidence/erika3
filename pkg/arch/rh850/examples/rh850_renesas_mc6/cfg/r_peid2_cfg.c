...
/** \file   r_peid2_cfg.c
 *  \brief  project configuration for PEID2  (core 2)
 *
 ...
 *******************************************************************************/
const g4mh_isr_t g_peid2_FePrjCfg[] =
{
