...
/** \file   r_peid5_cfg.c
 *  \brief  project configuration for PEID5  (core 5)
 *
 ...
 *******************************************************************************/
const g4mh_isr_t g_peid5_FePrjCfg[] =
{
