...
/** \file   r_g4mh_cfg.c
 *  \brief  project configuration of G4MH core - exception/interrupt vectors
 *
 ...
 *******************************************************************************/
const g4mh_isr_t g_g4mh_FePrjCfg[] =
{
