...
/** \file   r_peid0_cfg.c
 *  \brief  project configuration for PEID0  (core 0)
 *
 ...
 *******************************************************************************/
const g4mh_isr_t g_peid0_FePrjCfg[] =
{
