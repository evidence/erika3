...
/* Assure to enable VFP support if the compiler have been invoked with hardware
   float support */
#if (defined(__TI_VFP_SUPPORT__))
#if (!defined(OSEE_CORTEX_R_VFP))
#define OSEE_CORTEX_R_VFP
#endif /* !OSEE_CORTEX_R_VFP */
#endif /* __TI_VFP_SUPPORT__ */

/* Override default HDB to add fields to handle VIM */
#define OSEE_CORTEX_R_HDB_OVERRIDE
