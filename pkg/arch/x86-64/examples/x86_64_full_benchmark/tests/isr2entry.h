...
/** \file	isr2entry.h
 *  \brief	Test: ISR2ENTRY
 *
 *  Measure the time between when an interrupt occurs and its handler (ISR2)
 *  is executed.
 *
 *  \author	Errico Guidieri
 *  \date	2018
 */
#ifndef __ISR2ENTRY_H__
#define __ISR2ENTRY_H__
