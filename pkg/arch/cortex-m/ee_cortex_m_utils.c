...
/** \file   ee_cortex_m_utils.c
 *  \brief  Cortex-M Utilities Implementation.
 *
 *  This files contains the implementation of the utilities for Cortex-M
 ...
 */
void osEE_cortex_m_WriteCCPReg(volatile OsEE_reg * addr, OsEE_reg value)
{
#if 0
