...
/* TriBoard 2x7 default clock frequency (20MHz) */
#define OSEE_TRIBOARD_2X7_FOSC	20000000U
/* Interface Board Oscillator Frequency Define */
#define OSEE_TC2YX_BOARD_FOSC	OSEE_TRIBOARD_2X7_FOSC
/* Interface Board Oscillator Frequency Define */
#define OSEE_TC27X_BOARD_FOSC	OSEE_TRIBOARD_2X7_FOSC

enum OsEE_tc2x7_led_id {
  OSEE_TRIBOARD_2X7_NO_LEDS = 0x00,
  OSEE_TRIBOARD_2X7_LED_1 = 0x01,
  OSEE_TRIBOARD_2X7_LED_2 = 0x02,
  OSEE_TRIBOARD_2X7_LED_3 = 0x04,
  OSEE_TRIBOARD_2X7_LED_4 = 0x08,
  OSEE_TRIBOARD_2X7_LED_5 = 0x10,
  OSEE_TRIBOARD_2X7_LED_6 = 0x20,
  OSEE_TRIBOARD_2X7_LED_7 = 0x40,
  OSEE_TRIBOARD_2X7_LED_8 = 0x80,
  OSEE_TRIBOARD_2X7_ALL_LEDS = 0xFF
};

/*  User LEDs are in pull down configuration so the logic is
    inverted respect pin output value */
enum OsEE_tc2x7_led_status {
  OSEE_TRIBOARD_2X7_LED_ON  = 0,
  OSEE_TRIBOARD_2X7_LED_OFF = 1
};

OSEE_STATIC_INLINE void OSEE_ALWAYS_INLINE OsEE_tc2x7_turn_led(
    enum OsEE_tc2x7_led_id led_id, enum OsEE_tc2x7_led_status onoff
) {
  switch(led_id) {
    case OSEE_TRIBOARD_2X7_LED_8:
      P33_OUT.B.P13 = (uint8_t)onoff;
    break;
    case OSEE_TRIBOARD_2X7_LED_7:
      P33_OUT.B.P12 = (uint8_t)onoff;
    break;
    case OSEE_TRIBOARD_2X7_LED_6:
      P33_OUT.B.P11 = (uint8_t)onoff;
    break;
    case OSEE_TRIBOARD_2X7_LED_5:
      P33_OUT.B.P10 = (uint8_t)onoff;
    break;
    case OSEE_TRIBOARD_2X7_LED_4:
      P33_OUT.B.P9 = (uint8_t)onoff;
    break;
    case OSEE_TRIBOARD_2X7_LED_3:
      P33_OUT.B.P8 = (uint8_t)onoff;
    break;
    case OSEE_TRIBOARD_2X7_LED_2:
      P33_OUT.B.P7 = (uint8_t)onoff;
    break;
    case OSEE_TRIBOARD_2X7_LED_1:
...
OsEE_tc2x7_set_leds_mask(uint8_t leds_mask)
{
  P33_OUT.B.P13   =   (((uint32_t)leds_mask &
    (uint32_t)OSEE_TRIBOARD_2X7_LED_8) != (uint32_t)0U) ?
    (uint8_t)OSEE_TRIBOARD_2X7_LED_ON: (uint8_t)OSEE_TRIBOARD_2X7_LED_OFF;
  P33_OUT.B.P12   =   (((uint32_t)leds_mask &
    (uint32_t)OSEE_TRIBOARD_2X7_LED_7) != (uint32_t)0U) ?
    (uint8_t)OSEE_TRIBOARD_2X7_LED_ON: (uint8_t)OSEE_TRIBOARD_2X7_LED_OFF;
  P33_OUT.B.P11   =   (((uint32_t)leds_mask &
    (uint32_t)OSEE_TRIBOARD_2X7_LED_6) != (uint32_t)0U) ?
    (uint8_t)OSEE_TRIBOARD_2X7_LED_ON: (uint8_t)OSEE_TRIBOARD_2X7_LED_OFF;
  P33_OUT.B.P10   =   (((uint32_t)leds_mask &
    (uint32_t)OSEE_TRIBOARD_2X7_LED_5) != (uint32_t)0U) ?
    (uint8_t)OSEE_TRIBOARD_2X7_LED_ON: (uint8_t)OSEE_TRIBOARD_2X7_LED_OFF;
  P33_OUT.B.P9    =   (((uint32_t)leds_mask &
    (uint32_t)OSEE_TRIBOARD_2X7_LED_4) != (uint32_t)0U) ?
    (uint8_t)OSEE_TRIBOARD_2X7_LED_ON: (uint8_t)OSEE_TRIBOARD_2X7_LED_OFF;
  P33_OUT.B.P8    =   (((uint32_t)leds_mask &
    (uint32_t)OSEE_TRIBOARD_2X7_LED_3) != (uint32_t)0U) ?
    (uint8_t)OSEE_TRIBOARD_2X7_LED_ON: (uint8_t)OSEE_TRIBOARD_2X7_LED_OFF;
  P33_OUT.B.P7    =   (((uint32_t)leds_mask &
    (uint32_t)OSEE_TRIBOARD_2X7_LED_2) != (uint32_t)0U) ?
    (uint8_t)OSEE_TRIBOARD_2X7_LED_ON: (uint8_t)OSEE_TRIBOARD_2X7_LED_OFF;
  P33_OUT.B.P6    =   (((uint32_t)leds_mask &
    (uint32_t)OSEE_TRIBOARD_2X7_LED_1) != (uint32_t)0U) ?
    (uint8_t)OSEE_TRIBOARD_2X7_LED_ON: (uint8_t)OSEE_TRIBOARD_2X7_LED_OFF;
}

OSEE_STATIC_INLINE void OSEE_ALWAYS_INLINE OsEE_tc2x7_leds_on( void )
{
  OsEE_tc2x7_turn_led(OSEE_TRIBOARD_2X7_ALL_LEDS, OSEE_TRIBOARD_2X7_LED_ON);
}

OSEE_STATIC_INLINE void OSEE_ALWAYS_INLINE OsEE_tc2x7_leds_off( void )
{
  OsEE_tc2x7_turn_led(OSEE_TRIBOARD_2X7_ALL_LEDS, OSEE_TRIBOARD_2X7_LED_OFF);
}

OSEE_STATIC_INLINE void OSEE_ALWAYS_INLINE OsEE_tc2x7_leds_init( void )
{
  OsEE_tc2x7_leds_off();
...
/* Infineon TriBoard-TC2X7_V2.0 come without buttons, but RESET button.
...
OSEE_STATIC_INLINE void OSEE_ALWAYS_INLINE
OsEE_tc2x7_button_irq_init( EE_TYPEISR2PRIO intvec )
{
...
OSEE_STATIC_INLINE void OSEE_ALWAYS_INLINE
OsEE_tc2x7_button_irq_clear_request( void )
{
  /* Clear the request */
  SCU_FMR.B.FC5       = 1U;
}
